...
function MainSite() {
  ...
  return (
    <div className="min-h-screen bg-[#fcfbf9] text-slate-800 font-sans selection:bg-red-100 selection:text-red-900">
            ...
            <div className="flex flex-col items-center gap-6 p-8">
              {['Home', 'About', 'Activities', 'Contact'].map((item) => (
                <a 
                  ...
                  className="text-3xl font-serif font-black text-slate-900 uppercase tracking-tighter"
                >
                  {item}
                </a>
              ))}
              ...
              <div className="w-full pt-6 mt-4 border-t border-slate-100 flex flex-col items-center gap-3">
                ...
                <div className="flex items-center gap-4 justify-center">
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="w-12 h-12 rounded-full bg-[#1877F2] flex items-center justify-center text-white shadow-lg shadow-blue-100"
                    title="Facebook"
                  >
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="w-12 h-12 rounded-full bg-[#E1306C] flex items-center justify-center text-white shadow-lg shadow-pink-100"
                    title="Instagram"
                  >
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="w-12 h-12 rounded-full bg-[#25D366] flex items-center justify-center text-white shadow-lg shadow-green-100"
                    title="WhatsApp"
                  >
      ...
      {/* Hero Section */}
      <header id="home" className="relative pt-36 pb-12 overflow-hidden bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="relative rounded-[2.5rem] overflow-hidden shadow-2xl min-h-[500px] md:min-h-[580px] bg-slate-900 flex items-center"
          >
            {/* Background Image */}
            <img 
              src={IMAGES.gallery3} 
            ...
            {/* Content Container */}
            <div className="relative z-10 w-full flex flex-col justify-end px-6 sm:px-12 md:px-16 lg:px-20 pb-12 pt-32 min-h-[500px] md:min-h-[580px] text-white">
              <div className="inline-flex self-start items-center gap-2 px-4 py-1.5 rounded-full bg-red-500/25 text-red-300 text-[10px] font-black uppercase tracking-[0.2em] mb-4 border border-red-500/30 backdrop-blur-sm">
                <Target className="w-3.5 h-3.5" />
                Serving Lucknow Since 2016
              </div>
              
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-sans font-extrabold leading-tight tracking-tight mb-4 text-white drop-shadow-md">
                Voice for the <span className="text-red-400">Voiceless.</span>
              </h2>
              
              <p className="text-base sm:text-lg md:text-xl text-slate-200 font-medium leading-relaxed max-w-xl opacity-95 drop-shadow-sm">
            ...
            <div className="absolute bottom-6 right-6 bg-white/90 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-white/20 max-w-[220px] hidden lg:block">
              ...
              <p className="text-[10px] text-slate-500 leading-tight">Join our community of heart-led individuals.</p>
            </div>
          </motion.div>
        </div>
      </header>
                    ...
                    {paymentMethod === 'bank' ? (
                      ...
                      <div className="bg-[#f2f5ff] p-8 rounded-[2.5rem] flex flex-col items-center">
                        ...
                        <div className="bg-white p-6 rounded-[2rem] shadow-sm mb-6 w-full max-w-[260px] flex flex-col items-center">
                          ...
                          <p className="text-sm font-bold text-slate-700 tracking-tight">UPI ID: MAB0450018A0033160@Yesbank</p>
                        </div>
